...
\keywords{social media, content moderation, transparency report, audit, minor
safety, sexual exploitation of minors, child sexual abuse material, CSAM,
CyberTipline, CyberTipline report, National Center for Missing and Exploited
...
taxonomy of content categories \cite{BankoMacKeenea2020}


----------------------- auditing


transparency essential for effective legislation \cite{MacCarthy2022}

transparency first \cite{Krass2022} what does it mean \cite{TworekWanless2022}

requirements \cite{MacCarthy2020}

survey of remedies~\cite{Goldman2021}


risk assessment \cite{TheActionCoalitionOnMeaningfulTransparency2023}
survey of audit techniques~\cite{AdaLovelaceInstitute2021}

complexity of AI audits, survey~\cite{CostanzaChockRajiea2022}

techniques for auditing recommender systems with eye towards DSA
\cite{MessmerDegeling2023}

considerable uncertainty about DSA audits at end of 2023 \cite{BhatiaAllen2023}


audit of search headlines \cite{ZadeWackea2022}


reviewability \cite{CobbeLeeea2021}
accountability \cite{Bovens2006}




hard to find, misleading metrics \cite{AntiDefamationLeague2021}

EFF recommendations \cite{WindwehrYork2020}




Facebook category audit \cite{BradfordGriselea2019} \cite{Plumb2019}
pipeline and controls audit \cite{Sarang2022}





EFF \cite{CrockerGebhartea2019}


----------- Legal

\cite{} responses \cite{Kadri2022,MinowMinow2023}

be careful \cite{Douek2022}   new governors \cite{Klonick2018}


social media and other platforms discredit the US \cite{GeltzerGhosh2018}

---------- Audits

different policies for online harassment  \cite{PaterKimea2016} \cite{PerkinsCrystea2021}
self harm


---------- Detection

platforms clearly prefer automated detection \cite{Pfefferkorn2022}
