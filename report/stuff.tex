...
\caption{(a) Quarterly pieces for Facebook and Instagram (Meta); (b) Yearly
    reports vs pieces for Meta (NCMEC and Meta)}
\Description{Charting cheek to cheek}
\label{fig:reports-by-corp}
\end{figure}
...
TikTok's disclosures suffer from several problems that, taken together, render
its statistics useless. First, the firm is the only one to disclose the total
number of videos removed as counts but the shares of content categories and
subcategories as percentage fractions. It also distinguishes between automated
and non-automated moderation, but before Q2 2023 did not report all shares,
making it impossible to derive the count for CSAM or ``Sexual exploitation of
minors.'' For Q2 2023, TikTok reorganized its classification and reporting,
ostensibly to provide \emph{more} granularity.
